	...
	<div class="edit-form" id="myForm">
		...
		<table class="table" >
			...
			%> </td> <br> 
				...
				<tr>
					<td>Data added  :</td>
					<td><input type="text" placeholder="Enter new date added" name="datadded"  /><br/></td>
				</tr>
				<tr>
					<td><button type="submit" class="btn">Edit Details</button></td>
					<td><button type="Reset" class="btn cancel" >Cancel</button></td>
				</tr>
			</form>
	</div>
